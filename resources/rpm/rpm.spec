...
Requires:  php-composer(%{c_vendor}/tc-lib-file) >= 1.2.0
...
Requires:  php-composer(%{c_vendor}/tc-lib-pdf-font-core) < 2.0.0
Requires:  php-composer(%{c_vendor}/tc-lib-pdf-font-core) >= 1.4.0
